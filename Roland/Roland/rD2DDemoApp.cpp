...
HRESULT DemoApp::CreateDeviceDependentResources()
{
    HRESULT hr = S_OK;
...
void DemoApp::OnResize(UINT width, UINT height)
{
    if (m_pRenderTarget)
    {
        // Note: This method can fail, but it's okay to ignore the error
        // here, because the error will be return again the next time
        // EndDraw is called.
